...
- 对模型的前后处理做了性能优化。CenterPoint在[nuScenes](https://www.nuscenes.org/nuscenes) val set上精度有50.61 mAP，速度在Tesla V100上达到了45.7FPS。
- 提供[KITTI数据集](http://www.cvlibs.net/datasets/kitti/eval_object.php?obj_benchmark=3d)上的训练配置和Baseline。CenterPoint在KITTI val set上精度达到62.55 mAP，速度在Tesla V100上达到了28.31FPS。
