...
class NuscenesMVSegDataset(NuscenesDetDataset):
    """
    ...
    def __init__(self,
        ...
        self.lane_ann_file = lane_ann_file
    ...
    def _build_data(self):
        ...
        if test:
            ...
            if os.path.exists(train_ann_cache_file):
                ...
                return
        #print('self.version for nusc: ', self.version)
    ...
    @property
    def metric(self):
        print('self.version for metric: ', self.version)
