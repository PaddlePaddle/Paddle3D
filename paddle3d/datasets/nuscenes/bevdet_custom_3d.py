...
class Custom3DDataset(BaseDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        """
        return pickle.load(ann_file)  #mmcv.load(ann_file, file_format='pkl')
    ...
    def get_ann_info(self, index):
        ...
        gt_bboxes_3d = ori_box_type_3d(gt_bboxes_3d,
    ...
    # def evaluate(self, results, metric=None, iou_thr=(0.25, 0.5), logger=
    #     None, show=False, out_dir=None, pipeline=None):
    #     """Evaluate.
    ...
    #         logger=logger, box_type_3d=self.box_type_3d, box_mode_3d=self.
    #         box_mode_3d)
    #     if show:
    ...
    #         f'_build_default_pipeline is not implemented for dataset {self.__class__.__name__}'
    #     )
    ...
    #             warnings.warn(
    #                 'Use default pipeline for data loading, this may cause errors when data is on ceph'
    #             )
    #             return self._build_default_pipeline()
    #         loading_pipeline = get_loading_pipeline(self.pipeline.transforms)
    #         return T.Compose(loading_pipeline)
