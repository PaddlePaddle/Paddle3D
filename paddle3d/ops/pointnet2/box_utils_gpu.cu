...
__global__ void points_in_boxes_cuda_kernel(const int batch_size, const int boxes_num, const int pts_num, const float *boxes,
...
void points_in_boxes_cuda_launcher(const int batch_size, const int boxes_num, const int pts_num, const float *boxes,
    ...
    points_in_boxes_cuda_kernel<<<blocks, threads>>>(batch_size, boxes_num, pts_num, boxes, pts, box_idx_of_points);
