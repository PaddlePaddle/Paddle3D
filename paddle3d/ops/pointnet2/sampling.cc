...
std::vector<paddle::Tensor> farthest_point_sampling_cuda_forward(
    ...
    auto temp_tensor = paddle::full({b, n}, 1e10, paddle::DataType::FLOAT32, paddle::GPUPlace());
    auto idx_tensor = paddle::empty({b, npoints}, paddle::DataType::INT32, paddle::GPUPlace());
...
// dtype infer
std::vector<paddle::DataType> FPSInferDtype(
