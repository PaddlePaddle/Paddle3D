...
class CustomFPN(nn.Layer):
    ...
    def __init__(self,
        ...
        self.lateral_convs = nn.LayerList()  #nn.ModuleList()
    ...
    def init_weights(self):
        self.lateral_convs.apply(param_init.init_weight)
        self.fpn_convs.apply(param_init.init_weight)
