            ...
            for sample in self.train_dataloader:
                ...
                if status.save_checkpoint and env.local_rank == 0:
                    ...
                    if uniform_output_enabled:
                        ...
                        best_export_savepath = os.path.join(self.checkpoint.rootdir, "best_model", "inference")
                        ...
                        epoch_export_yml_savepath = os.path.join(savepath, 'inference.yml')
                        best_export_yml_savepath = os.path.join(best_export_savepath, 'inference.yml')
                        shutil.copy2(epoch_export_yml_savepath, best_export_yml_savepath)
