...
* @param [in] input_distortion_coeffs distortion coefficient, must be 6, order k1 k2 k3 k4 p1 p2
* @param [in] xy_undist distortion corrected coordinates (in camera coordinate system) Nx2
...
* @param [in] max_iterations iterations
* @param [in] eps     
* @return xy_undist distortion corrected coordinates (in camera coordinate system) Nx2
*/
...
/**
* @brief distortion correction interface, supports automatic selection to run on cpu or gpu according to the input tensor type
*
* @param [in] xy_coords input xy coordinate (in camera coordinate system) Nx2
* @param [in] input_distortion_coeffs distortion coefficient, must be 6, order k1 k2 k3 k4 p1 p2
* @return Distortion corrected coordinates (in camera coordinate system) Nx2
